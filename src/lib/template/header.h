 ...
 *         The caller is responsible for freeing the returned pointer using free_template().
 */
 ...
 * @param template A pointer to the template content previously loaded with load_template().
 */
